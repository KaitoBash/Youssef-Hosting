...
# ============== بيانات المسؤول ==============
ADMIN_USERNAME = "8792200095"
ADMIN_PASSWORD_RAW = "8792200095"

# ============== إعدادات البوت والإشعارات ==============
BOT_TOKEN = "8973613955:AAE-xUZyJxTCgrQQI5vPWaI3xDu9mB211ok"
ADMIN_TELEGRAM_ID = 8792200095
ADMIN_TELEGRAM_USERNAME = "@VD_D6"
...
def api_register():
    ...
    threading.Thread(
        target=notify_admin,
        args=(
            f"🔔 *مستخدم جديد اشترك في Youssef HOST!*\n"
            f"👤 المستخدم: `{username}`\n"
