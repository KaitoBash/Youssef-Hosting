#!/usr/bin/env python3
"""
Youssef 𝙷𝙾𝚂𝚃 - بوت التحكم الكامل
طُوِّر بواسطة: YOUSSEF KAITO | @DV_V6
"""
...
# معلومات المطور
DEVELOPER_INFO = "🛠 طِّور بواسطة: Youssef*\n تواصل: @VD_D6"
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, edit=False):
    ...
    keyboard.append([InlineKeyboardButton("💬 تواصل مع المطور @VD_D6", url="https://t.me/VD_D6")])
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("💬 تواصل مع المطور @VD_D6", url="https://t.me/VD_D6")],
    ]
...
async def handle_api_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = api_request("/api/bot/verify", method="POST", data={"api_key": api_key})
    if not result or not result.get("success"):
        keyboard = [[InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/VD_D6")]]
        await update.message.reply_text(
            "❌ *مفتاح API غير صالح!*\n\n"
            "تحقق من الكود وحاول مرة أخرى\n"
            "أو تواصل مع المطور: @VD_D6",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup(keyboard),
        )
        return WAITING_FOR_API_KEY
